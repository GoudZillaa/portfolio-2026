...
const ImpactHero = () => {
    return (
        <section className="relative min-h-screen flex flex-col items-center justify-center pt-32 pb-16 overflow-hidden w-full">
            {/* Grid lines */}
            <div className="absolute inset-0 grid-bg opacity-30" />
            {/* Aurora Background Mask */}
            <div className="absolute inset-x-0 top-0 h-[800px] pointer-events-none z-0" style={{ maskImage: 'linear-gradient(to bottom, black 30%, transparent 100%)', WebkitMaskImage: 'linear-gradient(to bottom, black 30%, transparent 100%)' }}>
                <Aurora
                    colorStops={["#a340b0", "#B19EEF", "#5227FF"]}
                    amplitude={1.0}
                    blend={0.5}
                    speed={1.0}
                />
            ...
            <div className="relative z-10 max-w-6xl mx-auto px-6 text-center w-full">
                ...
                >
                    ...
                    {/* <br /> */}
                    <AuroraText colors={["#a6bada", "#c390d1", "#e4cde2", "#e1d9f0"]} speed={1}>GOUD</AuroraText>
                </motion.h1>
                ...
                <div className="relative py-16 w-full flex flex-col items-center justify-center">
                    <div className="absolute inset-0 flex h-[500px] w-full items-center justify-center pointer-events-none z-0 opacity-60 -translate-y-52">
                        <OrbitingCircles radius={120} duration={25}>
                            <ReactIcon className="text-foreground w-20 h-20 md:w-12 md:h-12" />
                            <TailwindIcon className="text-foreground w-20 h-20 md:w-12 md:h-12" />
                        </OrbitingCircles>
                        <OrbitingCircles radius={220} duration={35} reverse>
                            <DatabaseIcon className="text-foreground w-20 h-20 md:w-12 md:h-12" />
                            <PhpIcon className="text-foreground w-20 h-20 md:w-12 md:h-12" />
                        </OrbitingCircles>
                        <OrbitingCircles radius={320} duration={50}>
                            <NodeIcon className="text-foreground w-20 h-20 md:w-12 md:h-12" />
                            <ReactIcon className="text-foreground w-20 h-20 md:w-12 md:h-12" />
                        </OrbitingCircles>
                    </div>
